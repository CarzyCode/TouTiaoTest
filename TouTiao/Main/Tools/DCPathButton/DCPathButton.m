...
- (void)configureViewsLayout
{
    ...
    self.foldCenter = CGPointMake(self.bloomSize.width / 2, self.bloomSize.height - 100.0f);
...
- (void)resizeToFoldedFrame
{
    [UIView animateWithDuration:0.0618f * 3
                     ...
                     animations:^{
        self->_pathCenterButton.transform = CGAffineTransformMakeRotation(0);
                     }
                     completion:nil];
